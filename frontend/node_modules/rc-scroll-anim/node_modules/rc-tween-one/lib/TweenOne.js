    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (typeof nextMoment === 'number' && nextMoment !== this.props.moment) {
        if (this.tween && !this.updateAnim) {
          ...
          this.startTime = _ticker2['default'].time;
          if (nextProps.paused) {
            this.raf();
          }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setDefalut = function (props) {
    ...
    _this2.startTime = _ticker2['default'].time;
  };
  ...
  this.frame = function () {
    ...
    var moment = _ticker2['default'].time - _this2.startTime + _this2.startMoment;
    if (_this2.reverse) {
      moment = (_this2.startMoment || 0) - (_ticker2['default'].time - _this2.startTime);
    }
